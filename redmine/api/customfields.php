...
class CustomFields extends ApiLayer{
    ...
    public function all(array $filter = array(), $offset = null, $limit = null){
        ...
        return $this->_all(
            $this->mysqli->query("SELECT * FROM custom_fields". $filter ." LIMIT ". $offset .",". $limit)
        );
    }
    ...
    public function get($id){
        ...
        return $this->_get(
            $this->mysqli->query("SELECT * FROM custom_fields WHERE id = '". $id ."'")
        );
    }
